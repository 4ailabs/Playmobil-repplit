/**
 * Constantes para el sistema de OH Cards
 * Integrado desde ohcards-system para asignar imágenes y palabras a muñecos
 */
...
export const IMAGE_CARD_URLS: string[] = [
  ...
  "https://images.squarespace-cdn.com/content/v1/63937c55c3c2e84a13a3ede9/6ebb56eb-9e9c-4408-82fd-a498ccee533f/Cartas+Oh_88.png"
];
...
export const WORD_CARD_DATA: string[] = [
  ...
  "Falta", "Familia", "Felicidad", "Fracaso", "Fuerza", "Futuro", "Ganar",
  "Generosidad", "Gratitud", "Guía", "Hogar", "Honestidad", "Humillación", "Ideal",
  "Idea", "Ilusión", "Imaginación", "Impaciencia", "Incompleto", "Inocencia", "Intimidad",
  "Invencible", "Juego", "Libertad", "Límite", "Loco", "Lujuria", "Mentira",
  "Miedo", "Muerte", "Naturaleza", "Nuevo", "Oportunidad", "Orgullo", "Paciencia",
  "Paz", "Peligro", "Poder", "Protección", "Rebelión", "Rechazo", "Regalo",
  "Relación", "Resistencia", "Responsabilidad", "Riesgo", "Risa", "Salud", "Seguridad",
  "Sexualidad", "Sueño", "Sufrimiento", "Tiempo", "Trabajo", "Traición", "Tristeza",
  "Venganza", "Vergüenza", "Vida", "Violencia", "Vulnerabilidad"
];
